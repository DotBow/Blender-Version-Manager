...
"}")
        ...
        self.zeroBuildsWarning = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.zeroBuildsWarning.sizePolicy().hasHeightForWidth())
        self.zeroBuildsWarning.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.zeroBuildsWarning.setFont(font)
        self.zeroBuildsWarning.setStyleSheet("color: white;")
        self.zeroBuildsWarning.setTextFormat(QtCore.Qt.PlainText)
        self.zeroBuildsWarning.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignHCenter)
        self.zeroBuildsWarning.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        self.zeroBuildsWarning.setObjectName("zeroBuildsWarning")
        self.verticalLayout_2.addWidget(self.zeroBuildsWarning)
