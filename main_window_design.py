...
"}")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/fake.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionToggleRegisterBlend.setIcon(icon7)
        ...
        self.actionToggleRunMinimized.setIcon(icon7)
        ...
        self.actionToggleRunOnStartup.setIcon(icon7)
