...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/clear.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionClearTempFolder.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/tray.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionMinimizeToTray.setIcon(icon1)
        self.actionMinimizeToTray.setObjectName("actionMinimizeToTray")
        self.actionQuit = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/quit.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
