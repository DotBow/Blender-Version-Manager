...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/clear.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionClearTempFolder.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/tray.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionMinimizeToTray.setIcon(icon2)
        self.actionMinimizeToTray.setObjectName("actionMinimizeToTray")
        self.actionQuit = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/quit.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
